...
public sealed class SubmitTriviaAnswerHandler : IRequestHandler<SubmitTriviaAnswerCommand, SubmissionResultDto>
{
    ...
    public SubmitTriviaAnswerHandler(
    ...
    public async Task<SubmissionResultDto> Handle(SubmitTriviaAnswerCommand request, CancellationToken cancellationToken)
    {
        ...
        var result = session.SubmitTriviaAnswer(
