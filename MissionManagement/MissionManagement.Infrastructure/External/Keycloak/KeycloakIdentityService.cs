...
public sealed class KeycloakIdentityService : IIdentityService
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        {
            throw new ConflictException($"Ya existe un operador registrado con el correo '{email}'.");
        }
        ...
        if (!Guid.TryParse(keycloakUserId, out var operatorId))
        {
    ...
    private static string ExtractUserIdFromLocationHeader(string? locationHeader)
    {
        ...
        {
            throw new InvalidOperationException("Keycloak no devolvió la cabecera Location al crear el operador.");
        }
